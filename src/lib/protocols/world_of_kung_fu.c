...
{
  ndpi_set_detected_protocol(ndpi_struct, flow, NDPI_PROTOCOL_WORLD_OF_KUNG_FU, NDPI_PROTOCOL_UNKNOWN, NDPI_CONFIDENCE_DPI);
}
...
{
  ndpi_set_bitmask_protocol_detection("WorldOfKungFu", ndpi_struct, *id,
